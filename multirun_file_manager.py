...
def file_reset(directory):
    ...
    datafile = open( "In-Process-JSONS/inbox_vals.json", "w", encoding="utf-8" )  # opening json file for writing
...
def file_getcount(inbox):
    ...
    datafile = open( "In-Process-JSONS/inbox_vals.json", "r", encoding="utf-8" )
...
def file_idgen(directory):
    ...
    datafile = open( "In-Process-JSONS/inbox_ids.json", "w", encoding="utf-8" )  # opening json file for writing
